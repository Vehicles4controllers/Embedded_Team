...
{
    float GyroX = IMU_u16GetGyroZ();
    float GyroY = IMU_u16GetGyroZ();
    float GyroZ = IMU_u16GetGyroZ();
    ...
    anglePITCH += GyroY*135.0/(400000.0);
    angleROLL += GyroX*135.0/(400000.0);
...
{
    double pitch_acc;
    double acc_total_vector = sqrt((IMU_u16GetACCX()*IMU_u16GetACCX()) + (IMU_u16GetACCY()*IMU_u16GetACCY()) + (IMU_u16GetACCZ()*IMU_u16GetACCZ()));
    pitch_acc = asin((float)IMU_u16GetACCY()/acc_total_vector)* 57.296;
    return pitch_acc;
}
float IMU_u16GetROLL_ACC(void)
{
    ...
    double roll_acc;
    double acc_total_vector = sqrt((IMU_u16GetACCX()*IMU_u16GetACCX()) + (IMU_u16GetACCY()*IMU_u16GetACCY()) + (IMU_u16GetACCZ()*IMU_u16GetACCZ()));
    roll_acc = asin((float)IMU_u16GetACCX()/acc_total_vector)* 57.296;
    return roll_acc;
}
